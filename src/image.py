...
class Image:
    ...
    def add_path_car_like(self, path, car_length=0.1, action_time=0.05, resolution=20, color=(253, 198, 117), width=0.005):
        """
        ...
        Args:
            ...
            action_time: action_time used when calling solve_car_like
        ...
        for sample in path[:-1]:
            self.__add_car_like_curve(sample, sample[3], action_time, car_length, resolution, color, width)

    def add_tree_car_like(self, tree, car_length=0.1, action_time=0.05, resolution=20, color=(87, 126, 137),
                          width=0.0045):
        """
        Adds RRT tree generated by the car like algorithm to the image.
        ...
        def __plot_recursive(root):
            ...
            for child in root.children:
                self.__add_car_like_curve(root.state, child.state[3], action_time, car_length, resolution, color,
                                          width)
